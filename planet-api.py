...
app.config['JWT_SECRET_KEY'] = 'super-secret' # change this IRL, its not secure lol 
...
def remove_planet(planet_id:int):
    ...
    if planet:
        ...
        return jsonify(message='That planet was not found'), 404
